...
export type NodeSumSummerCourse = EdgeNode & MetaTagInterface & NodeInterface & {
  ...
  /** Cross Listing */
  sumCourseCrossListing?: Maybe<Scalars['String']['output']>;
  /** Description */
  ...
  /** Population */
  sumCoursePopulation?: Maybe<TermSumCoursePopulation>;
  /** Prerequisites */
