...
const PageFooter = async () => {
  const superFooterConfig = await getConfigPage<StanfordSuperFooter>(
    "StanfordSuperFooter"
  );
  const localFooterConfig = await getConfigPage<StanfordLocalFooter>(
    "StanfordLocalFooter"
  );
      ...
      <div className="bg-cardinal-red py-10 [&_a]:text-white [&_a]:no-underline [&_a:hocus]:text-white ">
        <div className="centered lg:flex lg:items-start lg:gap-20">
          <div className="text-center mb-10">
            <a
              className="font-stanford text-center"
