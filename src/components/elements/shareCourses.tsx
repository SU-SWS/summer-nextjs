  ...
  return (
    ...
    >
      <button aria-expanded={expandedShare} onClick={toggleExpandedShare} aria-controls={elementId}>
        <ShareIcon width={20} className="text-poppy" />
        <span className="sr-only">Share</span>
      </button>
      <ul 
        id={elementId}
        className={twMerge("list-unstyled absolute z-10 top-full right-0 w-full min-w-[350px] bg-fog-light border border-white rounded-[25px] px-12 py-4 mt-3", expandedShare ? "block" : "hidden")}
      >
